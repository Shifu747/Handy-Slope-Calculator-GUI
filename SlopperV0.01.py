...
def calculate_tab1_output(*args):
    try:
        upstream_IL = float(eval(tab1_input1.get()))
        length = float(eval(tab1_input2.get()))
        raw_slope = float(eval(tab1_input3.get()))
...
def calculate_tab2_output(*args):
    try:
        downstream_IL = float(eval(tab2_input1.get()))
        length = float(eval(tab2_input2.get()))
        raw_slope = float(eval(tab2_input3.get()))
...
def calculate_tab3_output(*args):
    try:
        upstream_IL = float(eval(tab3_input1.get()))
        downstream_IL = float(eval(tab3_input2.get()))
